...
set(handles.popupmenu7,'String',textcell);
set(handles.popupmenu8,'String',textcell);
...
set(handles.mod_c7_button,'BackgroundColor',EC.nod.CMm_temp(val,:));
...
set(handles.mod_c8_button,'BackgroundColor',EC.nod.CMm_temp(val,:));
...
function mod_c7_button_Callback(hObject, eventdata, handles)
% hObject    handle to mod_c7_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global EC
c = uisetcolor('Select Color');
if length(c) == 3
    set(hObject,'BackgroundColor',c);
    EC.nod.CMm_temp(get(handles.popupmenu7,'Value'),:) = c;
end

function mod_c8_button_Callback(hObject, eventdata, handles)
% hObject    handle to mod_c7_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global EC
...
if length(c) == 3
    set(hObject,'BackgroundColor',c);
    EC.nod.CMm_temp(get(handles.popupmenu8,'Value'),:) = c;
end
